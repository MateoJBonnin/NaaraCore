...
#pragma warning restore 219
    ...
    public static JSONObject Vector3ToData(UnityEngine.Vector3 vector3)
    {
        JSONObject data = new JSONObject();
        data.AddField("x", vector3.x);
        data.AddField("y", vector3.y);
        data.AddField("z", vector3.z);
        return data;
    }
...
{
    public static UnityEngine.Vector3 ToVector3(this JSONObject jSONObject)
    {
        return new UnityEngine.Vector3(jSONObject["x"].f, jSONObject["y"].f, jSONObject["z"].f);
    }
}