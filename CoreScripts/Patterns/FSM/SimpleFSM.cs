...
public class SimpleFSMCustomState<Database, State, Key, Data> : GenericFSMCustomState<Database, AbstractFSMTransitionerCustomState<State, Key, Data>, State, Key, Data> where Data : AbstractFSMData where State : IFSMState<Data> where Database : AbstractFSMStateDatabaseCustomState<State, Key, Data>
{
